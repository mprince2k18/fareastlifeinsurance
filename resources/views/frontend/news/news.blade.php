              ...
              <div class="col-lg-12">
                    ...
                    <div class="event-single d-flex flex-wrap">
                        <div class="event-date">
                            <h1 class="display-1">{{ $n->created_at->format('d') }}</h1>
                            <span class="month">{{ $n->created_at->format('F') }}</span>
                            <span class="year">{{ $n->created_at->format('Y') }}</span>
                        </div><!-- ends: .event-date -->
                        <div class="event-info">
                            <div>
                                <h4 style="color: #000;"><a  href="{{ url('notice-single/') }}/{{ $n->id }}">{!! html_entity_decode($n->news_title) !!}</a></h4>
