              ...
              <div class="col-lg-12">
                    ...
                    <div class="event-single d-flex flex-wrap">
                        <div class="event-date">
                            <h1 class="display-1">{{ $claim->created_at->format('d') }}</h1>
                            <span class="month">{{ $claim->created_at->format('F') }}</span>
                            <span class="year">{{ $claim->created_at->format('Y') }}</span>
                        </div><!-- ends: .event-date -->
                        <div class="event-info">
                            <div>
                                <h4 style="color: #000;"><a  href="{{url("show/claim/pdf")}}/{{ $claim->id }}/{{ $claim->claimPdf }}">{!! html_entity_decode($claim->claim) !!}</a></h4>
