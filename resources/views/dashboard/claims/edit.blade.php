...
@section('content')
      ...
      <div class="br-mainpanel">
        ...
        <!--               <a class="breadcrumb-item" href="#">Dashboard</a>-->
                   <span class="breadcrumb-item active">Update CLAIM</span>
                </nav>
        </div>
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
          <h4 class="tx-gray-800 mg-b-5">Update CLAIM</h4>
        </div>
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            ...
            <!-- form-layout -->
            					...
            					<form action="{{ route('claim_update',$claim->id) }}" method="post" enctype="multipart/form-data">
                       {{method_field('PUT')}}
                                    {{csrf_field()}}
                           ...
                           <div class="col-7 col-sm-8">
                             <input class="form-control" type="text" name="icon" value="{{$claim->icon}}" >

                           </div>

                           <div class="col-7 col-sm-8">
                             <label>Claim Date</label>
                             <input class="form-control" type="date" name="claimDate" placeholder="ion-spin" value="{{$claim->claimDate}}">
                           </div>
                           <div class="col-7 col-sm-8">
                             <label>Upaold PDF(If not necessary leave it)</label>
                             <input class="form-control" type="file" name="claimPdf" placeholder="ion-spin">
                           </div>

                         </div>

                               <textarea name="claim" id="summernote" cols="30" rows="10">{{$claim->claim}}</textarea>
