                            ...
                            <div class="form-layout form-layout-7">
                                <form action="{{ route('fareast_star_create') }}" method="post" enctype="multipart/form-data">
                                  @csrf
                                    ...
                                    <!-- Add New Logo-->
                                    <div class="row no-gutters">
                                        <div class="col-5 col-sm-4"> Fareast Star Thumbnail: </div>
                                        <div class="col-7 col-sm-8">
                            ...
                            <div class="card"> <img class="card-img-top img-fluid" src="{{ asset('uploads/fareaststar') }}/{{ $star->thumbnail }}" alt="{{ $star->name }}">
                                <div class="card-body">
                                    <div class="text-center">
                                       ...
                                       <a href="{{route('fstarvalues.index',$star->id)}}" class="btn btn-oblong btn-success">Details Value</a> 
                                       <a href="{{route('fareast_star_upadate',$star->id)}}" class="btn btn-oblong btn-info">Edit</a>

                                      <a href="{{ url('/dashboard/fareast/star/delete') }}/{{ $star->id }}" class="btn btn-oblong btn-danger">Remove</a> </div>
